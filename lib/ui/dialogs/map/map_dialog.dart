...
class MapDialog extends StackedView<MapDialogModel> {
      ...
      child: SizedBox(
        ...
        child: Stack(children: [
              ...
              child: Column(
                children: [
                  IconButton(
                    ...
                    onPressed: () {
                      viewModel.changeSearchRadius(viewModel.circleRadius! + 5);
                    },
                  ),
                  Expanded(
                    child: RotatedBox(
          ...
          Positioned(
              ...
              right: 0,
              child: VStack([
                if (viewModel.busy(viewModel.selectedLocation))
                ...
                "Save"
                    ...
                    .onTap(viewModel.selectedLocation !=
                            null // Conditionally add onTap
  ...
  Widget _buildMap(BuildContext context, MapDialogModel viewModel) {
    return FlutterMap(
            ...
            circles: [
              CircleMarker(
                ...
                radius: viewModel.circleRadius ??
                    10, // Use the radius from the view model
